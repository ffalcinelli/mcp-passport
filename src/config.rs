...
pub struct Config {
    ...
    #[arg(long, env = "MCP_PASSPORT_KC_PAR_URL", help_heading = "OIDC Overrides")]
    ...
    #[arg(long, env = "MCP_PASSPORT_AUTH_SCHEME", value_enum, default_value_t = AuthScheme::Bearer, help_heading = "Protocol & Security")]
